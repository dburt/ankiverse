...
class BollsPassageFetcherIntegrationTest < Minitest::Test
  ...
  def test_fetch_psalm_117_kjv
    use_cassette('bolls/test_fetch_psalm_117_kjv') do
  ...
  def test_fetch_john_3_16_kjv
    use_cassette('bolls/test_fetch_john_3_16_kjv') do
  ...
  def test_fetch_with_verse_numbers
    use_cassette('bolls/test_fetch_with_verse_numbers') do
  ...
  def test_fetch_genesis_1_1
    use_cassette('bolls/test_fetch_genesis_1_1') do
  ...
  def test_api_availability
    use_cassette('bolls/test_api_availability') do
